...
#   WORK IS NOT MINE, BY: @amobiny on GitHub
#   Curated by: Alexis Echano

#   PURPOSE: To classify handwritten numbers with the actual number

#   Uses the Google Tensorflow library
import tensorflow as tf

# Load MNIST data - a dataset of handwritten numbers
